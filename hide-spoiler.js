kw = ['Avengers: Endgame', 'Captain Marvel', 'Avengers Endgame', 'AVENGERS: Endgame', 'AVENGERS: ENDGAME', 'Endgame', 'ENDGAME', 'AVENGERS ENDGAME', 'Endgame Spoilers', 'Avengers: Endgame spoilers', 'Thanos', 'Avenge The Fallen', 'Thanos Dead', 'Tony Stark', 'Avengers', 'Antman' ,'avengers endgame']
tags = "SPANEMBIULOLI";
total = 0;
...
function hideNode(node) {
	node.textContent = '[TEXT BLOCKED: ENDGAME SPOILER DETECTED]';
